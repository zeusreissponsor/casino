        ...
        <div className=" ">
          ...
          <div className=" h-[50px] bg-[#292d2e] rounded-lg  ">
            <div className=" flex items-center justify-between px-2 ">
              ...
              <div onClick={() => setOpen((prev) => !prev)} className="relative cursor-pointer w-[150px] bg-[#292d2e] border border-[#656565] rounded-md flex items-center justify-between p-1 text-[16px] my-2 font-semibold">
