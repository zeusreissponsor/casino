...
const SoccerSearchBar = () => {
  ...
  const searchSports = [
    { name: "UEFA Champions League", img: "/Sports/international.svg" },
    { name: "Premier League", img: "/Sports/ENG.svg" },
    { name: "La Liga", img: "/Sports/ESP.svg" },
    { name: "ATP Doha", img: "/Sports/QAT.svg" },
    { name: "ATP Rio de Janeiro", img: "/Sports/BRA.svg" },
    { name: "NBA", img: "/Sports/USA.svg" },
    { name: "NCAA, Regular Season", img: "/Sports/USA.svg" },
    { name: "S | ESL Pro League Season 21", img: "/Sports/international.svg" },
    { name: "S | PGL Cluj-Napoca 2025", img: "/Sports/international.svg" },
  ];
  return (
    <div className="pt-16">
      <div className="flex justify-center items-center mt-5 w-[100%] mx-5 ">
        <input
          type="text"
          placeholder="Search..."
          className="w-full bg-[#292d2e]  px-4 py-2 border border-none rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
          value={query}
          onChange={(e) => setQuery(e.target.value)}
        />
      </div>

      <div className="w-[100%] left-0 h-[30px] px-5 rounded-lg flex items-center justify-start gap-2 font-bold text-gray-400 text-[14px] mt-5 overflow-x-scroll custom-scrollbar whitespace-nowrap hide-scrollbar ">
        {searchSports.map((sport) => (
          <div
            key={sport.name}
            onClick={() => SetPopular(sport.name)}
            className={`w-[250px] rounded-xl cursor-pointer px-2 ${
              popular === sport.name
      ...
      <div className="flex flex-col items-center justify-center text-center p-4 mt-5">
        <svg
