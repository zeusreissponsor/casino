...
const Earth = () => {
  ...
  const [Earth, setEarth] = useState("UEFA Champions League");
        ...
        <div>
          <div className="w-[100%] mt-3 p-4 flex items-center gap-2  ">
            <div className="relative">
              ...
              {IsOpen1 && (
                <div className="absolute bg-[#292d2e] h-96 shadow-md rounded-md mt-1 w-[400px] px-4 py-3 overflow-y-scroll custom-scrollbar hide-scrollbar z-50">
                  <div className="">
                    <button
            ...
            <div className="flex items-center justify-start gap-2  overflow-x-scroll custom-scrollbar whitespace-nowrap hide-scrollbar">
              ...
              <div
                ...
                className={`w-[25%] rounded-xl p-1 flex items-center justify-center ${
              ...
              >
                <div className="flex items-center justify-start gap-2">
                  ...
                  />
                  <button className="text-sm">UEFA Champions League</button>
                </div>
              </div>

              <div
                onClick={() => setEarth("UEFA Europa League")}
                className={`w-[20%] rounded-xl p-1 flex items-center justify-center ${
              ...
              >
                <div className="flex items-center justify-start gap-2">
                  <img
                    ...
                    className="Earth w-[25px] h-[25px] "
                  />
                  <button className="text-sm">UEFA Europa League</button>
                </div>
              </div>

              <div
                onClick={() => setEarth("Copa Sudamericana ")}
                className={`w-[20%] rounded-xl p-1 flex items-center justify-center ${
                  Earth === "Copa Sudamericana "
                    ? "bg-green-500 text-black font-bold px-2"
                    : "text-white  bg-[#3a4142]"
                }`}
              >
                <div className="flex items-center justify-start gap-2">
                  <img
                    ...
                    className="Earth w-[25px] h-[25px] "
                  />
                  <button className="text-sm">Copa Sudamericana</button>
                </div>
              </div>

              <div
                onClick={() => setEarth("FIFA Club World Cup")}
                className={`w-[20%] rounded-xl p-1 flex items-center justify-center ${
                  Earth === "FIFA Club World Cup"
                    ? "bg-green-500 text-black font-bold px-2"
                    : "text-white  bg-[#3a4142]"
                }`}
              >
                <div className="flex items-center justify-start gap-2">
                  <img
                    ...
                    className="Earth w-[25px] h-[25px] "
                  />
                  <button className="text-sm">FIFA Club World Cup</button>
                </div>
              </div>

              <div
                onClick={() =>
                  setEarth("U19 European Championship, Women, Qualification")
                }
                className={`w-[20%] rounded-xl p-1 flex items-start justify-start ${
                  Earth === "U19 European Championship, Women, Qualification"
                    ? "bg-green-500 text-black font-bold px-2"
                    : "text-white  bg-[#3a4142]"
                }`}
              >
                <div className="flex items-center justify-start gap-2">
                  ...
                  <button className="text-xs">
                    U19 European Championship, Women, Qualification
                  </button>
                </div>
              </div>
            </div>
                  ...
                  <div>
                    <div className="flex items-center justify-start gap-2">
                      <img
                        ...
                        className="Earth w-[25px] h-[25px] "
                      />
                      <strong className="text-md">Copa Sudamericana</strong>
                    </div>
                    <div>
                      <LiveCardSoccer />
                    </div>
                  ...
                  <div>
                    <div className="flex items-center justify-start gap-2">
                      <img
                        ...
                        className="Earth w-[25px] h-[25px] "
                      />
                      <strong className="text-md">FIFA Club World Cup</strong>
                    </div>
                    <div>
                      <LiveCardSoccer />
                    </div>
                  ...
                  <div>
                    <div className="flex items-center justify-start gap-2">
                      <img
                        ...
                        className="Earth w-[25px] h-[25px] "
                      />
                      <strong className="text-md">U19 European Championship, Women, Qualification</strong>
                    </div>
                    <div>
                      <LiveCardSoccer />
                    </div>
