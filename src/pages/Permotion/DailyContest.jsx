  ...
  return (
    <>
      <div className="w-full mt-14">
        <div className="w-[97%] mx-auto bg-[#232626] m-10 flex gap-4 items-stretch">
              ...
              <div className="flex flex-col items-center text-center">
                <div className="flex items-center">
                  ...
                  <img
                    ...
                    className="transform -scale-x-100 ml-2"
                  />
                </div>
        ...
        {/* asdfghjk */}
        <div className="w-[97%] mx-auto flex bg-[#323738] p-4 rounded-xl">
          <div className="flex-1 flex items-center">
            <img
              ...
              alt="Avatar"
            />
            <div className="font-extrabold text-primary">Krcdnemqmuac</div>
          </div>
